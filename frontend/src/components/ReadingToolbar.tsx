...
export default function ReadingToolbar({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-[#d7dce4] bg-white p-4 shadow-[0_5px_14px_rgba(15,23,42,0.13)] md:flex-row md:items-center md:justify-between">
      ...
      <button
        ...
        className="inline-flex items-center justify-center gap-2 rounded-lg border border-[#cbd2dc] bg-white px-4 py-2.5 text-sm font-black text-[#061c44] transition hover:bg-[#f1f4f8]"
      >
        <span aria-hidden="true">✣</span>
        {simplified ? "Texto Original" : "Simplificar com IA"}
      </button>
    </div>
  );
}
