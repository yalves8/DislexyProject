...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0] flex flex-col items-center justify-center px-4 py-10">
      <h1 className="text-2xl font-bold text-gray-800 mb-1">Leitor Dislexy</h1>
      <p className="text-blue-500 text-sm mb-8">Sua biblioteca de leitura acessível</p>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm flex flex-col gap-6">
        ...
        <button
          ...
          className="text-sm text-blue-500 hover:text-blue-700 text-center transition-colors disabled:opacity-60"
        >
